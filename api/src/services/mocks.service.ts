...
const MENU_MOCK: Product[] = [
  {
    ...
    stats: { rating: 4.8, reviewsCount: 124 },
    promotions: {
      hasDiscount: true,
  ...
  },
  {
    ...
    stats: { rating: 4.9, reviewsCount: 89 },
    promotions: { hasDiscount: false },
    metadata: {
      createdAt: nowDate,
      updatedAt: nowDate,
      createdBy: "admin_01",
  ...
  },
  {
    ...
    stats: { rating: 4.5, reviewsCount: 56 },
    promotions: {
      hasDiscount: true,
  ...
  },
  {
    ...
    stats: { rating: 4.7, reviewsCount: 210 },
    promotions: { hasDiscount: false },
    metadata: {
      createdAt: nowDate,
      updatedAt: nowDate,
  ...
  },
  {
    ...
    stats: { rating: 4.8, reviewsCount: 342 },
    promotions: { hasDiscount: false },
    metadata: {
      createdAt: nowDate,
      updatedAt: nowDate,
  ...
  },
  {
    ...
    stats: { rating: 4.3, reviewsCount: 88 },
    promotions: { hasDiscount: false },
    metadata: {
      createdAt: nowDate,
      updatedAt: nowDate,
  ...
  },
  {
    ...
    stats: { rating: 4.6, reviewsCount: 42 },
    promotions: { hasDiscount: false },
    metadata: {
      createdAt: nowDate,
      updatedAt: nowDate,
...
const CUSTOMIZATIONS_MOCK: ProductCustomization[] = [
  {
    ...
    sections: [
      {
        id: "burger-protein",
        title: "Choose your Protein (Required)",
        type: "single",
        minOptions: 1,
        maxOptions: 1,
        options: [
          { id: "beef-standard", name: "Premium Beef Patty", priceInCents: 0 },
          {
            id: "wagyu-upgrade",
            name: "Upgrade to Wagyu Beef",
            priceInCents: 500,
          },
          { id: "plant-based", name: "Beyond Meat Patty", priceInCents: 200 },
        ],
      },
      {
        id: "extra-toppings",
        ...
        maxOptions: 4,
        options: [
          { id: "extra-bacon", name: "Extra Crispy Bacon", priceInCents: 180 },
          { id: "egg", name: "Fried Egg", priceInCents: 120 },
          { id: "avocado", name: "Fresh Avocado", priceInCents: 150 },
      ...
      },
      {
        ...
        options: [
          {
            id: "house-sauce",
            name: "Signature Sun Fu Sauce",
            priceInCents: 0,
          },
          { id: "bbq-artisanal", name: "Artisanal BBQ", priceInCents: 40 },
          { id: "spicy-mayo", name: "Chipotle Mayo", priceInCents: 40 },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      {
        id: "wrap-protein",
        title: "Protein Selection (Required)",
        type: "single",
        minOptions: 1,
        maxOptions: 1,
        options: [
          ...
          { id: "falafel-option", name: "Crispy Falafel", priceInCents: 200 },
        ],
      },
      {
        id: "wrap-toppings",
        ...
        maxOptions: 3,
        options: [
          { id: "nacho-strips", name: "Nacho Strips", priceInCents: 70 },
      ...
      },
      {
        ...
        maxOptions: 2,
        options: [
          { id: "mild-salsa", name: "Mild Salsa", priceInCents: 0 },
          { id: "atomic-hot", name: "Atomic Hot Sauce", priceInCents: 50 },
        ],
      },
    ],
  },
...
export const seedProducts = async () => {
  ...
  // Subir Productos
  MENU_MOCK.forEach((product) => {
    const ref = db.collection("products").doc(product.id);
    batch.set(ref, product);
  });

  // Subir Personalizaciones
  CUSTOMIZATIONS_MOCK.forEach((custom) => {
    const ref = db.collection("product_customizations").doc(custom.id);
    batch.set(ref, custom);
  });

  await batch.commit();
  console.log("Successfully seeded 7 products and their customization groups.");
};
